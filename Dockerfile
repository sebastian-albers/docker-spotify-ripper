...
RUN apt-get -qq update && \
    ...
    apt-get -qq update && \
    apt-get -qq install -y libspotify12 libspotify-dev python python-pkg-resources libffi-dev python-pip python-dev lame flac vorbis-tools fdkaac && \
    ...
    apt-get -qq --purge autoremove -y libffi-dev python-pip python-dev libspotify-dev curl apt-transport-https apt-transport-https wget && \
    apt-get clean && \
